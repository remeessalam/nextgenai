      ...
      <div className="wrapper">
        <div className="pt-[5rem] pb-[1rem] grid md:grid-cols-[30%_65%] gap-10">
          <div className="w-full hidden md:flex flex-col gap-10">
            <div
              data-aos="fade-up"
              className="bg-gray-200 p-4 lg:p-6 rounded-lg"
            >
            ...
            <div
              data-aos="fade-up"
              className="text-center bg-gray-200 flex flex-col items-center gap-5 text-white px-4 lg:px-6 py-10 rounded-lg"
            >
              <div className="w-[3.5rem] h-[3.5rem] bg-black text-primary rounded-full p-3 flex justify-center items-center">
              ...
              <Link
                ...
                className="bg-main rounded-md w-full px-5 text-sm font-medium py-3 text-white hover:-translate-y-1 hover:shadow-xl hover:bg-white hover:text-black border border-main cursor-pointer transition-all duration-300"
              >
                Contact Now
              </Link>
            </div>
