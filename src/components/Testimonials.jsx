...
import testiImg from "../assets/images/landingpages/banner-bg.jpg";
      ...
      <div className="wrapper grid lg:grid-cols-2 gap-10 w-full">
        ...
        >
          <div className="flex items-center gap-3 mb-5">
            ...
            <h6 className="font-medium text-main">Testimonials</h6>
          </div>
          ...
          {testimonials.map((item) => (
            ...
            >
              <img
                ...
                alt=""
              />
              <div className="sm:pl-[5rem] text-black sm:pr-[3rem] pt-[3rem] sm:pt-0 flex flex-col gap-3">
